...
// //         <button className="block w-fit m-auto px-4 py-5 bg-purple-100 text-smaller sm:text-small lg:text-white rounded-5 hover:bg-purple-200 transition-colors">
// //           Work with us
// //         </button>
// //       </div>
// //     </section>
...
// // --- Sub-component: VideoCard (Giữ nguyên logic cũ vì nó đã tốt) ---
...
//               {/* Tên Category (VD: Talking Head, Vlog...) */}
//               {category.name && (
//                 <Reveal>
